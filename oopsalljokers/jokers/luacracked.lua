...
SMODS.Joker{ --lua cracked
    ...
    loc_txt = {
        ['name'] = 'lua cracked',
        ['text'] = {
            [1] = 'When any other joker triggers add {C:money}$10 {}',
        ...
        if context.post_trigger  then
            return {
                func = function()local my_pos = nil
                    ...
                    target_card.ability.extra_value = (card.ability.extra_value or 0) + 10
                    target_card:set_cost()
                    return true
                end,
                message = "+"..tostring(10).." Sell Value"
            }
        end
